...
public class ListStyleButtonField extends Field {
	...
	public ListStyleButtonField(String label, String description, long style) {
		this(label, description, null, style);
	}

	public ListStyleButtonField(String label, String description,
			Bitmap actionIcon) {
		this(label, description, actionIcon, 0);
	}

	public ListStyleButtonField(String label, String description,
			Bitmap actionIcon, long style) {
		this(null, label, description, actionIcon, style);
	}

	public ListStyleButtonField(Bitmap icon, String label, String description,
			long style) {
		this(icon, label, description, null, style);
	}

	public ListStyleButtonField(Bitmap icon, String label, String description,
			Bitmap actionIcon, long style) {
		super(USE_ALL_WIDTH | Field.FOCUSABLE);
		_labelField = new MyLabelField(label, description, style);
	...
	private static class MyLabelField extends LabelField {
		...
		public MyLabelField(String text, String description, long style) {
			super(text, style);
